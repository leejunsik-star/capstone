...
function loadScript(src, namespace) {
  ...
  var key = cacheKey(src, namespace);
...
var NAMESPACE = "PaymentWidget";
var loadedRequests = /* @__PURE__ */ new Map();
function loadPaymentWidget(clientKey, customerKey, options) {
  ...
  return loadScript(src, NAMESPACE).then(function(PaymentWidget) {
...
function clearPaymentWidget() {
  ...
  loadedRequests.forEach(function(_ref) {
    ...
    var src = _ref.src, namespace = _ref.namespace;
  ...
  defaultScript === null || defaultScript === void 0 ? void 0 : (_defaultScript$parent = defaultScript.parentElement) === null || _defaultScript$parent === void 0 ? void 0 : _defaultScript$parent.removeChild(defaultScript);
