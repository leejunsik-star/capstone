...
var NAMESPACE = 'PaymentWidget'; // loadPaymentWidget 가 시도한 (src, namespace) 를 모듈 내부에 추적하여, clearPaymentWidget 가
...
function clearPaymentWidget() {
  ...
  loadedRequests.clear(); // fallback: loadPaymentWidget 를 거치지 않고 HTML inline / SSR / 다른 코드 경로로 직접 inject 된
